          ...
          <section>
            ...
            <div className="form-section-body">
              ...
              <div className="form-row">
                <label>Type<select name="bodyType" defaultValue={body?.bodyType ?? "mirrorless"} required><option value="mirrorless">Hybride</option><option value="dslr">Reflex</option></select></label>
