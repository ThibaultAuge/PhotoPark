...
export const accessorySchema = z.object({
  ...
  specCapacity: z.string().trim().max(120).nullable().default(null),
  specFormat: z.string().trim().max(120).nullable().default(null),
  specConnection: z.string().trim().max(120).nullable().default(null),
  specCompatibility: z.string().trim().max(160).nullable().default(null),
  specPower: z.string().trim().max(120).nullable().default(null),
  specColorModes: z.string().trim().max(120).nullable().default(null),
  specVariant: z.string().trim().max(120).nullable().default(null),
...
export function parseAccessoryFormData(formData: FormData) {
  return accessorySchema.parse({
    ...
    specCapacity: parseOptionalString(formData.get("specCapacity")),
    specFormat: parseOptionalString(formData.get("specFormat")),
    specConnection: parseOptionalString(formData.get("specConnection")),
    specCompatibility: parseOptionalString(formData.get("specCompatibility")),
    specPower: parseOptionalString(formData.get("specPower")),
    specColorModes: parseOptionalString(formData.get("specColorModes")),
    specVariant: parseOptionalString(formData.get("specVariant")),
